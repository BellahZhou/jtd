    ...
    TwbsPagination.prototype = {
        ...
        init: function (options) {
            ...
            if (this.options.onPageClick instanceof Function) {
                this.$element.off().bind('page', this.options.onPageClick);
            }
            ...
            this.show(this.options.startPage, false);
        },

        show: function (page, pageEvent) {
        ...
        setupEvents: function () {
            ...
            this.$listContainer.find('li').each(function () {
                ...
                $this.click(function () {
                    base.show(parseInt($this.data('page'), 10), true);
                });
            });
        },
    ...
    $.fn.twbsPagination = function (option) {
        ...
        var $set = this.each(function () {
            ...
            if (!data) {
                ...
                if (data.options.totalPages != option.totalPages ||
                    option.startPage != data.currentPage) {
                    $this.empty().data('twbs-pagination', (data = new TwbsPagination(this, options) ));
                }
            }
